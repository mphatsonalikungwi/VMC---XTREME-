...
const files = {
  ...
  'drawable/vmc_icon_foreground.xml': `<?xml version="1.0" encoding="utf-8"?><vector xmlns:android="http://schemas.android.com/apk/res/android" android:width="108dp" android:height="108dp" android:viewportWidth="108" android:viewportHeight="108"><path android:fillColor="#FFFFFFFF" android:pathData="M20,25 L34,25 L54,66 L74,25 L88,25 L62,82 L46,82 Z"/></vector>`,
...
console.log('VMC Android branding resources prepared.');
