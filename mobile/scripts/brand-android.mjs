...
const files = {
  ...
  'drawable/vmc_icon_foreground.xml': `<?xml version="1.0" encoding="utf-8"?><bitmap xmlns:android="http://schemas.android.com/apk/res/android" android:src="@drawable/vmc_logo" android:gravity="center"/>`,
...
console.log('Official VMC logo launcher resources prepared.');
